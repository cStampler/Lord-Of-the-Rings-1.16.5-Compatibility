...
public class LOTRCookingRecipeSerializer<T extends LOTRAbstractCookingRecipe> extends net.minecraftforge.registries.ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<T> {
	private final int defaultCookingTime;
	private final LOTRCookingRecipeSerializer.IFactory<T> factory;

	public LOTRCookingRecipeSerializer(LOTRCookingRecipeSerializer.IFactory<T> p_i50025_1_, int p_i50025_2_) {
	...
	public T fromJson(ResourceLocation p_199425_1_, JsonObject p_199425_2_) {
		...
		JsonElement jsonelement = JSONUtils.isArrayNode(p_199425_2_, "ingredient") ? JSONUtils.getAsJsonArray(p_199425_2_, "ingredient") : JSONUtils.getAsJsonObject(p_199425_2_, "ingredient");
		Ingredient ingredient = Ingredient.fromJson(jsonelement);
		// Forge: Check if primitive string to keep vanilla or a object which
		// can contain a count field.
	...
	interface IFactory<T extends LOTRAbstractCookingRecipe> {
