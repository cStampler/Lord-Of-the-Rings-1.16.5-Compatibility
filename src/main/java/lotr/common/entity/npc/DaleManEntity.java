...
public class DaleManEntity extends ManEntity {
	...
	static {
		WEAPONS = SpawnEquipmentTable.of(LOTRItems.DALE_DAGGER, LOTRItems.IRON_DAGGER, LOTRItems.BRONZE_DAGGER, Items.IRON_AXE, LOTRItems.BRONZE_AXE, Items.STONE_AXE);
	}
	...
	protected ITextComponent formatNPCName(ITextComponent npcName, ITextComponent typeName) {
		return new TranslationTextComponent("entityname.lotr.dale_man", npcName, typeName);
	}
