...
public class SwanfleetBiome extends LOTRBiomeBase {
	public SwanfleetBiome(boolean major) {
		super(new Builder().precipitation(RainType.RAIN).biomeCategory(Category.SWAMP).depth(-0.22F).scale(0.0F).temperature(0.8F).downfall(1.0F), major);
	}
	...
	protected void addVegetation(net.minecraft.world.biome.BiomeGenerationSettings.Builder builder) {
		Object[] weightedTrees = { LOTRBiomeFeatures.oak(), 500, LOTRBiomeFeatures.oakFancy(), 100, LOTRBiomeFeatures.oakSwamp(), 1000, LOTRBiomeFeatures.oakShrub(), 2500, LOTRBiomeFeatures.birch(), 500, LOTRBiomeFeatures.birchFancy(), 100 };
